...
namespace Back_End.Controllers
{
    ...
    public class ActoresController : ControllerBase
    {
        ...
        {
            var queriable = context.Actores.AsQueryable();
            await HttpContext.InsertarParametrosPaginacionEnCabecera(queriable);
            var actores = queriable.OrderBy(x => x.Nombre).Paginar(paginacionDTO).ToListAsync();
            return mapper.Map<List<ActorDTO>>(actores.Result);
        }
